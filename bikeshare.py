"""
 ...
 Name: Redi Delulo
 Project: 2 
 Purpose: Analyzing US Bikeshare data for three US cities.
 Date: 4/22/2020
"""
"""
 Reference websites
...
#name of the city and day
MONTH_DATA = ['all', 'january', 'february', 
...
def get_filters():
    ...
    while month_name.lower() not in MONTH_DATA:
        month_name = input("Thanks!!\nWhich month would you like to filter by?"
                           "\n\tJanuary, \n\tFebruary, \n\tMarch,"
                           "\n\tApril, \n\tMay, \n\tJune or \n\tAll if you want to see all  data?\n")
        if month_name.lower() in MONTH_DATA:
            ...
            print("Sorry!! I didn't catch that. Please try again. \n\tAll to apply all month"  
                  "or \n\tJanuary, \n\tFebruary, \n\tMarch,\n\tApril, \n\tMay, \n\tJune\n")

    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    day_name = ''
    while day_name.lower() not in DAY_DATA:
        day_name = input("\nThnk you, almost there!!\nAre you looking for a particular day?  \n\tSunday, Monday," 
                         "Tuesday, Wednesday,\n\tThursday, Friday, Saturday or 'All' if you want to see all data.\n")
        if day_name.lower() in DAY_DATA:
            #We were able to get the name of the month to analyze data.
            day = day_name.lower()
        else:
            #We were not able to get the name of the month to analyze data so we continue the loop.
            print("Oh No, something’s wrong. Please try again\n")
...
def main():
    while True:
        ...
        if restart.lower() != 'yes':
            print("Thank you for using US Bikshare Explorer\n\tGood bye!!")
            break
